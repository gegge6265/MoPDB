...
-- Dump della struttura del database worldok
CREATE DATABASE IF NOT EXISTS `worldok` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `worldok`;


-- Dump della struttura di tabella worldok.access_requirement
...
-- Dump dei dati della tabella worldok.access_requirement: 147 rows
...
INSERT INTO `access_requirement` (`mapId`, `difficulty`, `level_min`, `level_max`, `item`, `item2`, `quest_done_A`, `quest_done_H`, `completed_achievement`, `quest_failed_text`, `comment`) VALUES
	...
	(269, 1, 70, 0, 0, 0, 10285, 10285, 0, 'You must complete the quest "Return to Andormu" and be level 70 before entering the Heroic difficulty of the Black Morass.', 'Caverns Of Time,Black Morass (Entrance)'),
	...
	(645, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Blackrock Caverns (Entrance)'),
	(554, 0, 68, 0, 0, 0, 0, 0, 0, NULL, 'The Mechanar (Entrance)'),
	(645, 0, 77, 0, 0, 0, 0, 0, 0, NULL, 'Blackrock Caverns (Entrance)'),
	...
	(720, 0, 85, 0, 0, 0, 0, 0, 0, NULL, 'Firelands (Entrance) - 10N'),
	(720, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Firelands (Entrance) - 25N'),
	(720, 2, 85, 0, 0, 0, 0, 0, 5802, NULL, 'Firelands (Entrance) - 10H'),
	(720, 3, 85, 0, 0, 0, 0, 0, 5802, NULL, 'Firelands (Entrance) - 25H'),
	(725, 0, 80, 0, 0, 0, 0, 0, 0, NULL, 'The Stonecore (Entrance)'),
	(725, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'The Stonecore (Entrance)'),
	(754, 0, 85, 0, 0, 0, 0, 0, 0, NULL, 'Throne of the Four Winds (Entrance)'),
	(754, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Throne of the Four Winds (Entrance)'),
	(754, 2, 85, 0, 0, 0, 0, 0, 4851, NULL, 'Throne of the Four Winds (Entrance)'),
	(754, 3, 85, 0, 0, 0, 0, 0, 4851, NULL, 'Throne of the Four Winds (Entrance)'),
	(755, 0, 83, 0, 0, 0, 0, 0, 0, NULL, 'Lost City of the Tol\'vir (Entrance)'),
	(755, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Lost City of the Tol\'vir (Entrance)'),
	(757, 0, 85, 0, 0, 0, 0, 0, 0, NULL, 'Baradin Hold (Entrance) - 10N'),
	(757, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Baradin Hold (Entrance) - 25N'),
	(859, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Zul\'Gurub (Entrance)'),
	(938, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'End Time (Entrance)'),
	(939, 1, 85, 0, 0, 0, 0, 0, 6117, NULL, 'Well of Eternity (Entrance)'),
	(940, 1, 85, 0, 0, 0, 0, 0, 6118, NULL, 'Hour of Twilight (Entrance)'),
	(967, 0, 85, 0, 0, 0, 0, 0, 0, NULL, 'Dragon Soul (Entrance) - 10N'),
	(967, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Dragon Soul (Entrance) - 25N'),
	(967, 2, 85, 0, 0, 0, 0, 0, 6177, NULL, 'Dragon Soul (Entrance) - 10H'),
	(967, 3, 85, 0, 0, 0, 0, 0, 6177, NULL, 'Dragon Soul (Entrance) - 25H');
