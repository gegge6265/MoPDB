...
-- Dump della struttura di tabella worldok.command
...
-- Dump dei dati della tabella worldok.command: 493 rows
...
INSERT INTO `command` (`name`, `permission`, `help`) VALUES
	...
	('account lock ip', 3, 'Syntax: .account lock ip [on|off]\nAllow login from account only from current used IP or remove this requirement.'),
	...
	('group summon', 2, 'Syntax: .group summon [$charactername]\r\n\r\nTeleport the given character and his group to you. Teleported only online characters but original selected group member can be offline.'),
	...
	('gobject info', 3, 'Syntax: .gobject info [$object_entry]\r \r Query Gameobject information for selected gameobject or given entry.'),
