...
-- Dump della struttura di tabella worldok.game_tele
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2002 DEFAULT CHARSET=utf8 COMMENT='Tele Command';

-- Dump dei dati della tabella worldok.game_tele: 1.562 rows
...
INSERT INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(1524, 1665.49, 929.159, 471.178, 3.33285, 870, 'shrinetwomoons'),
	(1525, 821.489, 253.009, 503.92, 0.598881, 870, 'shrinesevenstars'),
	(1526, -296.103, -1767.74, 61.5928, 5.60186, 870, 'pandon'),
	(1527, 960.715, -2463.43, 471.178, 180.573, 870, 'jadeserpenttemple'),
	(1528, 6031.41, 1117.96, 55.935, 3.33285, 870, 'isleofgiants'),
	(1529, -698.285, -5040.82, -6.27675, 4.58871, 870, 'timelessisland'),
	(2000, 1471.67, 3466.25, 181.675, 2.70042, 860, 'pandastart'),
	(1530, 1, 1, 80, 1, 289, 'sholomanceold'),
	(1531, 1, 1, 80, 1, 189, 'scarlethallss'),
	(1532, 1, 1, 54, 1, 870, 'hawaiimaindown'),
	(1559, 1, 1, 170, 1, 870, 'hawaiimainup'),
	(1533, -3000, -4000, 50, 0, 930, 'alcazislandout'),
	(1534, -3000, -5000, 50, 0, 930, 'alcazislandin'),
	(1535, 3000, 3000, 450, 1, 959, 'shadopanmonastery'),
	(1536, 2000, -2000, 230, 1, 960, 'jadeserpent'),
	(1537, 100, 100, 160, 1, 960, 'stormstout'),
	(1538, 100, 100, 1, 1, 962, 'settingsun'),
	(1539, -100, -100, 1, 1, 995, 'moguinteriorraid'),
	(1540, -2000, -3000, 1, 1, 996, 'terraceendlessspring'),
	(1541, 1, 1, 1, 1, 998, 'kotmogu'),
	(1542, 1, 1, 1, 1, 1001, 'scarlethalls'),
	(1543, 1000, 1, 1, 1, 1004, 'scarletmonastery'),
	(1544, 1000, -1000, 1, 1, 1005, 'brewingstorm'),
	(1545, 1, 1, 1, 1, 1007, 'sholomance'),
	(1546, 1, 1, 250, 1, 1009, 'heartoffear'),
	(1547, 2000, 6000, 140, 1, 1011, 'niuzaotemple'),
	(1548, 2000, -2000, 1, 1, 1028, 'moguruins'),
	(1549, 1000, 1000, 550, 1, 1029, 'mogucrypt'),
	(1550, 1000, 1000, 150, 1, 1035, 'templekotmogu'),
	(1551, 2000, 5000, 1, 1, 1049, 'blackox'),
	(1552, -1000, 3000, 1, 1, 1050, 'zanvess'),
	(1553, 0, 0, 0, 0, 1051, 'brewmoonfestival'),
	(1554, 0, 0, 0, 0, 1060, 'devisland'),
	(1555, 0, 0, 0, 0, 1014, 'peakofserenity'),
	(1556, 0, 0, 0, 0, 1019, 'ruinsoftheramore'),
	(1557, 0, 0, 0, 0, 1024, 'greenstonevillage'),
	(1558, 0, 0, 0, 0, 1008, 'mogushanvaults'),
	(1560, 784.001, -331.87, 404.049, 5.27489, 870, 'blackmarket'),
	(1561, 16229.2, 16406, -64.3791, 60, 1, 'interrchamber'),
	(2001, 846.933, 1065.74, -9.57304, 3.39133, 730, 'malestrom');
